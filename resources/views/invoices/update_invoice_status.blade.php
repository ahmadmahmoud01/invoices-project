...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('update-invoice-status', $invoice->id) }}" method="post" autocomplete="off">
                        @csrf
                        @method('post')
                        {{-- 1 --}}
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="vat_rate" id="vat_rate" class="form-control" onchange="myFunction()" readonly>
                                    <!--placeholder-->
                                    <option value=" {{ $invoice->vat_rate }}">
                                        {{ $invoice->vat_rate }}
                                </select>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="vat_value" name="vat_value"
                                    value="{{ $invoice->vat_value }}" readonly>
                            </div>
