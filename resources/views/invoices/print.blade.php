                        ...
                        <div class="table-responsive mg-t-40">
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="tx-right">نسبة الضريبة ({{ $invoice->vat_rate }})</td>
                                        <td class="tx-right" colspan="2">{{ number_format($invoice->collection_amount * ($invoice->vat_rate / 100), 2) }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tx-right" colspan="2">
                                            <h4 class="tx-primary tx-bold">{{ number_format($invoice->total - $invoice->discount + ($invoice->collection_amount * ($invoice->vat_rate / 100)), 2) }}</h4>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
