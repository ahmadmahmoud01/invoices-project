                        ...
                        <div class="dropdown-menu">
                            <div class="menu-header-content bg-primary text-right">
                                <div class="d-flex">
                                    ...
                                    {{--  <span class="badge badge-pill badge-warning mr-auto my-auto float-left">تعيين الكل
                                        كمقروء</span>  --}}
                                        <button id="markAllReadButton" class="badge badge-pill badge-warning mr-auto my-auto float-left">Mark All as Read</button>

                                </div>
                                <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12" id="notifications_count">{{ Auth::user()->notifications->count() }}</p>
                            </div>
                            <div id="notifications" class="main-notification-list Notification-scroll">
                                @foreach (Auth::user()->notifications as $notification)
                                    <a class="d-flex p-3 border-bottom"
                                        ...
                                        <div class="mr-3">
                                            ...
                                            <div class="notification-subtext text-left">
