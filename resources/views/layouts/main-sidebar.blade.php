            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    ...
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ URL::asset('assets/img/faces/ahmad.jpg') }}"><span
                        class="avatar-status profile-status bg-green"></span>
                </div>
                <div class="user-info">
                    <h4 class="font-weight-semibold mt-3 mb-0">{{ auth()->user()->getRoleNames()->first() ?? '' }}</h4>
            ...
            @can('invoices')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @endcan
                        @can('invoices-partial-paid')
                            <li><a class="slide-item" href="{{ route('invoices.partially-paid') }}">الفواتير المدفوعة جزئيا</a>
                            </li>
                        @endcan
                        @can('invoices-archive')
                            <li><a class="slide-item" href="{{ route('invoices.archived') }}">أرشيف الفواتير</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan
