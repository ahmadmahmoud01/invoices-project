    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{ route('reports.invoices.search') }}" method="POST" role="search" autocomplete="off">
                    @csrf
                    ...
                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                        <label class="radiobox"><input name="radio" value="2" type="radio"><span>بحث برقم
                                الفاتورة
                            </span></label>
                    </div><br><br>
